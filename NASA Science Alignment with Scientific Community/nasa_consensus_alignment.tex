...
%% NOTE TO SELF: uncomment pdfauthor too
...
\usepackage{hyperref}
\hypersetup{
  pdftitle={NASA Science Alignment with Scientific Community},
...
\newcommand{\papertitle}{NASA Science Alignment with Scientific Community}
\title{\papertitle}
...
%% END Title, authors and addresses
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Abstract
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
...
\begin{description}
 ...
 \item[Science plan file names:] Follow a 
 \texttt{yyyy\_SSP\_Nasa\_File\_Name.pdf} format. 
 \texttt{SSP} represents Science mission directorate Science Plans. 
 This is replaced with \texttt{AD} to indicate Additional Documentation, \texttt{NSP} to indicate NASA Science Plan, or \texttt{AD} to indicate additional documentation present on the SMD website.
\end{description} 

%% ########### AI Declaration ############################################
\section*{Declaration of generative AI and AI-assisted technologies in the manuscript preparation process.}
\phantomsection
\label{ai_declaration}
During the preparation of this work the coresponding author used private, enterprise licensed, versions of Codex in order to generate short code snippets and review author generated code.
The coresponding author also used private, professional licensed, versions of Gemini to find related works, search known reference material, and augment search by providing summaries. No substantive changes to sentence structure or organization were completed by AI. 
After using these tools and services, the coresponding author reviewed and edited the content as needed and takes full responsibility for the content of the published article.
